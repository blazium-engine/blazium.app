...
released under the permissive [MIT license](https://github.com/blazium-games/blazium/blob/blazium-dev/LICENSE.txt).

The licenses for third-party libraries and code snippets used in the Blazium Engine are listed in the
[COPYRIGHT.txt](https://github.com/blazium-games/blazium/blob/blazium-dev/COPYRIGHT.txt) file available on Blazium Engine's GitHub repository.

### Logo

The Blazium Logo is licensed under the [CC0 1.0 Universal license](https://github.com/blazium-games/blazium/blob/blazium-dev/LOGO_LICENSE.txt).<br>
The files can be found in the [Brand Kit](/brand-kit).

### Fonts

All fonts used in the Blazium Engine and their licenses can be found in the [COPYRIGHT.txt](https://github.com/blazium-games/blazium/blob/blazium-dev/COPYRIGHT.txt)
